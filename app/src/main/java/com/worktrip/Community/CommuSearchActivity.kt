...
import com.worktrip.databinding.ActivityCommuSearchBinding
...
class CommuSearchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        com.worktrip.Community.binding = ActivityCommuSearchBinding.inflate(layoutInflater)
        val view = com.worktrip.Community.binding.root
        setContentView(view)
